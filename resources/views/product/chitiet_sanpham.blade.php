		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="/homepage">Trang chủ</a> / <span>Thông tin sản phẩm chi tiết</span>
				</div>
			</div>
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="/add-to-cart/{{$sanpham->id}}"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="col-sm-3 aside">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        @foreach($sp_banchay as $spbchay)
                        <div class="beta-sales beta-lists">
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="source/image/product/{{$spbchay->image}}" alt=""></a>
                                <div class="media-body">
                                    {{$spbchay->name}}
                                    <span class="beta-sales-price">${{$spbchay->unit_price}}</span>
                                </div>
                            </div>
                    ...
                    <div class="widget-body">
                        ...
                        <div class="beta-sales beta-lists">
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="source/image/product/{{$spnew->image}}" alt=""></a>
                                <div class="media-body">
                                    {{$spnew->name}}
