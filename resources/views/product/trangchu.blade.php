                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="/chitietsp/{{$new->id}}"><img
                                                src="source/image/product/{{$new->image}}" alt="" height="250px"></a>
                                    </div>
                                    ...
                                    <div class="single-item-caption">
                                        ...
                                        <a class="beta-btn primary" href="/chitietsp/{{$new->id}}">Details <i
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="/chitietsp/{{$spkm->id}}"><img
                                                src="source/image/product/{{$spkm->image}}" alt="" height="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="/add-to-cart/{{$spkm->id}}"><i
                                                class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary" href="/chitietsp/{{$spkm->id}}">Details <i
                                                class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
